...
If you discover a security vulnerability in PRLTC, please report it to the maintainers privately:

- **Email**: ekjotmakhija@gmail.com (or create a private security advisory on GitHub)
...
PRLTC is a CLI tool that executes shell commands and handles user input. PRs from external contributors undergo enhanced security review to protect against:
...
- **`hooks/prltc-rewrite.sh`** / **`.claude/hooks/prltc-rewrite.sh`** - Thin delegator hook (executes in Claude Code context, intercepts all commands)
...
See [Dangerous Patterns Reference](https://github.com/ekjotsinghmakhija/prltc/wiki/Dangerous-Patterns) for exploitation examples.
...
- **Security issues**: ekjotmakhija@gmail.com
- **General questions**: https://github.com/ekjotsinghmakhija/prltc/discussions
