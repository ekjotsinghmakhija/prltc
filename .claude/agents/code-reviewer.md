...
- Startup time optimization (<10ms target for PRLTC)
...
- **Framework Patterns**: Respect established patterns (e.g., PRLTC filter design, lazy_static regex)
...
## PRLTC-Specific Review Checklist

When reviewing PRLTC code, always verify:
...
- [ ] **No async**: PRLTC is single-threaded, no tokio/async-std
