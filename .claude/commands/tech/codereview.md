---
model: sonnet
description: PRLTC Code Review — Review locale pre-PR avec auto-fix
---

# PRLTC Code Review

Review locale de la branche courante avant création de PR. Applique les critères de qualité PRLTC.
...
- Output format inconsistant avec les autres filtres PRLTC
...
- `lazy_static!` avec `unwrap()` pour initialisation → pattern établi PRLTC
