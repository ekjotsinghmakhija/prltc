...
```bash
prltc --version  # Should show "prltc 0.18.1" (or newer)
...
```bash
pwd  # Verify you're in /Users/florianbruniaux/Sites/ekjotsinghmakhija/prltc
git branch  # Verify correct branch (main, feature/*, etc.)
```

**Never assume** which project to work in. PRLTC shares parent directory with other projects (ccboard, cc-economics).
