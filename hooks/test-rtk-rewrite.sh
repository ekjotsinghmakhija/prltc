...
test_rewrite "env + docker compose logs (supported, rewritten)" \
  ...
  "COMPOSE_PROJECT_NAME=test prltc docker compose logs web"
...
test_rewrite "docker compose up -d (NOT rewritten — unsupported by prltc)" \
  "docker compose up -d" \
  ""
...
test_rewrite "docker compose ps" \
  "docker compose ps" \
  "prltc docker compose ps"

test_rewrite "docker compose build" \
  "docker compose build" \
  "prltc docker compose build"

test_rewrite "docker compose down (NOT rewritten — unsupported by prltc)" \
  "docker compose down" \
  ""
