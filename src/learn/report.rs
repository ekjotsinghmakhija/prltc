...
pub fn format_console_report(
    ...
    output.push_str(&format!(
        "PRLTC Learn -- {} rules from {} corrections ({} sessions, {} days)\n",
        rules.len(),
        total_corrections,
        sessions,
        days
...
pub fn write_rules_file(rules: &[CorrectionRule], path: &str) -> Result<()> {
    ...
    content.push_str("# CLI Corrections (auto-generated by prltc learn)\n");
    content.push_str("# Run `prltc learn --write-rules` to update\n\n");
