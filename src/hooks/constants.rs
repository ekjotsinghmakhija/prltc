...
pub const REWRITE_HOOK_FILE: &str = "prltc-rewrite.sh";
pub const GEMINI_HOOK_FILE: &str = "prltc-hook-gemini.sh";
...
pub const OPENCODE_PLUGIN_PATH: &str = ".config/opencode/plugins/prltc.ts";
