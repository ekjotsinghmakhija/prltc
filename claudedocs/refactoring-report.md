# Refactoring Report: Elimination of Display Duplication in PRLTC
...
fn display_daily(tracker: &Tracker) -> Result<()> {
    ...
    let prltc_daily = tracker.get_all_days().context(...)?;
...
**Test 4: `prltc cc-economics --monthly`**
```
📅 Monthly Economics
════════════════════════════════════════════════════════
