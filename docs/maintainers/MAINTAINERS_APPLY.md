# PRLTC Maintainers Application

PRLTC is growing fast, with more contributors, PRs, and ideas than ever. To keep things moving smoothly, we're looking for new maintainers.
...
- 3+ merged PRs to PRLTC (filters, fixes, docs — all contributions count)
...
1. Open a discussion in [ekjotsinghmakhija/prltc Maintainers Applications · Discussions · GitHub](https://github.com/ekjotsinghmakhija/prltc/discussions/categories/maintainers-applications) titled **Maintainer Application: [Your GitHub Handle]**
2. In your application, include:
   ...
   - Your PRs that have been accepted in PRLTC
...
- A review of your ecosystem experience and understanding of PRLTC concepts
...
- Maintain consistency with the rest of the PRLTC ecosystem
...
Core Maintainers are responsible for the core of PRLTC. They have a broader scope and higher responsibilities and permissions, including:
...
If you enjoy contributing and want to help PRLTC scale in a healthy way, we'd be excited to have you onboard 🚀
